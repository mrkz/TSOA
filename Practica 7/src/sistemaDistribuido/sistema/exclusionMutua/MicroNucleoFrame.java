...
import sistemaDistribuido.sistema.exclusionMutua.PanelClienteServidor;
...
import sistemaDistribuido.sistema.exclusionMutua.ServidorFrame;
...
public class MicroNucleoFrame extends Frame implements WindowListener,Escribano,ParMaquinaProceso{
	...
	public MicroNucleoFrame(){
		super("Practica 7 - Exclusión mutua de procesos");
